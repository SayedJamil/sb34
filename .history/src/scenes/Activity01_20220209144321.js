        ...
        <Scenes
            ...
            sprites={
                <div className='activitytype01Screen'>
                    <Image src={activitytype01?.sprites[0]} alt="" className={cl} />
                    <Image src={activitytype01?.sprites[1]} alt="" className={cl} />
                    <Image src={activitytype01?.sprites[2]} alt="" className={cl} />
