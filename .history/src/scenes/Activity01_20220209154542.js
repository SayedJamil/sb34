        ...
        <Scenes
            ...
            sprites={
                <div className='activitytype01Screen'>
                    <Image src={activitytype01?.sprites[hW]} alt="" className={cl1} onClick={() => setCorrectHL(true)} />
                    {(correctHL) ? <Image src={activitytype01?.sprites[20]} alt="" className={cl1} /> : null}

                    <Image src={activitytype01?.sprites[hNw01]} alt="" className={cl2} onClick={() => setwrongHL01(true)} />
                    {(wrongHL01) ? <Image src={activitytype01?.sprites[21]} alt="" className={cl2} /> : null}

                    <Image src={activitytype01?.sprites[hNw02]} alt="" className={cl3} onClick={() => setwrongHL02(true)} />
                    {(wrongHL02) ? <Image src={activitytype01?.sprites[21]} alt="" className={cl3} /> : null}
