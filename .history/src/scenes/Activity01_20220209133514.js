        ...
        <Scenes
            ...
            sprites={
                <div className='activitytype01Screen'>
                    <Image src={activitytype01?.sprites[0]} alt="" className="activitytype01Title" />
                    <Image src={activitytype01?.sprites[1]} alt="" className="activitytype01TitleBG" />
                    <Image src={activitytype01?.sprites[2]} alt="" className="play_btn"
                        onClick={() => {
                            setisLoading(true)
                            setSceneId('/explain')
                            playSound.stop()
